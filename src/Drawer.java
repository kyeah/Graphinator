...
public class Drawer extends JPanel implements MouseMotionListener,MouseListener
{
	...
	public static void initButtons()
	{
		...
		Button vertexButton=new Button((short) 0, frame.getWidth()-x-200, frame.getHeight()-y-50, 100, 50);
		vertexButton.setText("Vertex");
		Button connectionButton=new Button((short) 1, frame.getWidth()-x-100, frame.getHeight()-y-50, 100, 50);
		connectionButton.setText("Connection");
		Button removeButton=new Button((short) 2, frame.getWidth()-x-300, frame.getHeight()-y-50, 100, 50);
